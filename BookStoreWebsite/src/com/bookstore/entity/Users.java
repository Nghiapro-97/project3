...
@Entity
@NamedQueries({
	@NamedQuery(name = "Users.filAll", query="SELECT u FROM Users u ORDER BY u.fullName"),
	@NamedQuery(name = "Users.filByEmail", query="SELECT u FROM Users u WHERE u.email = :email"),
